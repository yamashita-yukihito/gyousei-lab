...
このラボは、2026年11月8日の行政書士試験まで約3か月かけて、本人が問題を解きながら教材と分析機能を育てる長期プロジェクトである。直近10年の過去問は全6科目を一つのアプリに掲載済み。○×学習カードは**全6科目172件**を掲載済みである（行政法58、基礎知識32、民法25、憲法24、商法・会社法21、基礎法学12）。
...
- **頻出度は全172枚が同じ監査を通っている**（2026-07-29）。行政法55・民法25の80枚に加え、残る憲法24・基礎知識32・商法21・基礎法学12の89枚も、20年分の原問を1問ずつカードへ突き合わせて数え直し、`card_frequency_2006_2025.json`へ統合した。ラベルは問題数で機械的に決める（1〜2=重要論点、3〜5=繰り返し出題、6〜9=頻出、10以上=最頻出）。基礎知識だけは、令和3年改正の一元化と諸法令枠の新設により旧10年に同じ制度の出題がないため、直近10年が集計範囲である。
- **商法・会社法**は21枚を掲載している。最初の15枚は問36の商法総則・商行為と問37の設立を中心にしたが、20年分を再点検すると、問38〜40にも株式・機関・計算の安定した頻出論点があった。そのため、議決権制限種類株式、取締役会の特別利害関係人、監査役会、分配可能額など6枚を追加した。ただし得点計画は5問中1問が基準なので、今後は枚数を機械的に増やさず、実際の誤答か明確な頻出漏れがあるときだけ補う。
...
- ○×学習カード172件（行政法58、基礎知識32、民法25、憲法24、商法・会社法21、基礎法学12）
...
保存素材1,139問と、本番掲載569問・172カードを混同しない。
...
4. **商法・会社法21枚の検証**。設立・株式・機関・商行為・計算に絞っているので、実際の回答履歴を見て過不足を判断する。
