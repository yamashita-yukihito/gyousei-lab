...
- 独立ページへの入口は `static/architecture.html` の「engineに載せない、独立した2ページ」。
...
| ⑤ | **民法の固定キャラクター演習ページ**。事例問題のA・B・Cを毎回読み解く時間が無駄なので、登場人物を固定の配役にし、状況設定が一目で分かる形にする | A案を2026-07-31に公開（`static/minpo-a/`・16問）。B案を別AIへ依頼して比較する |
| ⑥ | 商法24枚の検証、誤答理由タグ | 未着手 |
