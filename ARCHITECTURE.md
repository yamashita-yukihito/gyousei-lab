...
このラボは、2026年11月8日の行政書士試験まで約3か月かけて、本人が問題を解きながら教材と分析機能を育てる長期プロジェクトである。直近10年の過去問は全6科目を一つのアプリに掲載済み。○×学習カードは行政法55件・民法25件・基礎知識20件・商法・会社法15件を掲載済みで、憲法・基礎法学へ順次拡張する。
...
- ○×学習カード115件（行政法55、民法25、基礎知識20、商法・会社法15）
...
保存素材1,139問と、本番掲載569問・115カードを混同しない。
