...
このラボは、2026年11月8日の行政書士試験まで約3か月かけて、本人が問題を解きながら教材と分析機能を育てる長期プロジェクトである。直近10年の過去問は全6科目を一つのアプリに掲載済み。○×学習カードは**全6科目167件**を掲載済みである（行政法58、基礎知識32、民法25、憲法21、商法・会社法21、基礎法学10）。
...
- ○×学習カード167件（行政法58、基礎知識32、民法25、憲法21、商法・会社法21、基礎法学10）
...
保存素材1,139問と、本番掲載569問・167カードを混同しない。
