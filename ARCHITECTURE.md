...
- `architectureVersion`: `2026-08-02`
- 更新日: 2026-08-02 JST
- 人間向け構成図: `static/architecture.html`
- AI向け正本: このファイル

このラボは、2026年11月8日の行政書士試験へ向けて、本人が問題を解きながら教材と分析機能を育てる長期プロジェクトである。8月は開発中心、9月から本格学習に入る。直近10年の過去問は全6科目を一つのアプリに掲載済み。○×学習カードは**全6科目200件**を掲載済みである（行政法70、基礎知識39、民法31、憲法24、商法・会社法24、基礎法学12）。
...
- ○×学習カード200件（行政法70、基礎知識39、民法31、憲法24、商法・会社法24、基礎法学12）
...
学習エンジンとは別に置いた独立ページ。**A案・B案・C案を作って使い比べるための試作**なので、
...
- 間隔を空けた「今日の学習」キュー
- 初見問題のholdoutと、90分・30問の本試験セッション土台
- 記述式の必須要素・答案履歴・再回答の強化
- A/B/C民法ドリルを実際に解き、保持率・時間・使いやすさで比較する
- 学習4時間は機能確認と初見診断に使い、教材の大量追加はしない

### Phase 2: 9月

- 200カードを一巡し、期限到来キューで再学習する
- 5肢択一・多肢選択・記述を毎週混ぜる
- 記述を週3〜5問、自分の文章で解く
...
2026-08-02の確認時点では200カード中178カードが未回答で、カード回答81回、過去問回答6回である。したがって、
...
| P0 | 初見holdoutと90分・30問の試験セッション | 8月 |
| P0 | 記述式の必須要素・答案履歴・再回答 | 8月 |
| P0 | 過去問誤答から誤肢解説・関連カードへ戻る導線 | 8月 |
| P0 | 7月31日追加13カードを頻出度監査JSONへ統合し、200件一致を検証 | 8月 |
| P0 | 誤答理由タグ。自信度dashboardはデータが貯まった後 | 8月〜9月 |
| P1 | A/B/C民法ドリルを実際に比較してD案を決める | 8月〜9月 |
...
| 2026-08-02 | 8月は開発中心、9月から本格学習。大量追加より「今日の学習」、初見holdout、本試験セッション、記述強化を優先 |
