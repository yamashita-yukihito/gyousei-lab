...
>
> 自信度の記録と卒業（習得済み・絶対覚えた・全リセット・卒業済みだけ）は2026年7月29日に実装済みです。次は基礎知識の残り（情報通信・情報セキュリティ、戸籍の届出の種類）、⑦「法律ごとの結論くらべ」の横断整備、商法・会社法の頻出15枚へ進んでください。優先順位の根拠は `ARCHITECTURE.md` の「1.5 得点計画」と「12. 次に行う作業」です。
>
