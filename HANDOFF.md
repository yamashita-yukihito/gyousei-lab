...
> 直近10年の全6科目569問は「過去問原文」と「記述式」へ掲載済みです。○×学習カードは172件で、**全6科目がそろっています**（行政法58・基礎知識32・民法25・憲法24・商法21・基礎法学12）。まず `AGENTS.md`、`HANDOFF.md`、`ARCHITECTURE.md`、`authoring/README.md`、`docs/SESSION_HANDOFF_20260729.md` を読んでください。
>
...
- 過去問: 569問
  ...
  - 多肢選択式: 30問
  - 記述式: 30問
- ○×学習カード: 172件（行政法58・基礎知識32・民法25・憲法24・商法・会社法21・基礎法学12）
  - ○×の内訳: ○73件・×94件（民法52%・憲法52%・基礎法学50%・基礎知識44%・商法43%・行政法36%）
- ⑤に使う関連過去問肢: 重複を除いて638件、各カードへの表示は延べ717件
- ⑥「似た制度・他分野との違い」: 66カード（関連付け67件）
...
- 法令基準日: 2026-04-01
- bundle revision:
  `5bbedeff1f24e6e442d627b9308885962cf07fd45b904bd6d5950fd9244d8b52`
