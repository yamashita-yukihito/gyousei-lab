...
**最新のセッション引き継ぎは `docs/SESSION_HANDOFF_20260729.md`。**
現在の到達点・次にやること・触るときの注意はそちらが最新である。

最初に、次の指示をそのまま実行する。

> 直近10年の全6科目569問は「過去問原文」と「記述式」へ掲載済みです。○×学習カードは187件で、**全6科目がそろっています**（行政法65・基礎知識32・民法30・憲法24・商法24・基礎法学12）。まず `AGENTS.md`、`HANDOFF.md`、`ARCHITECTURE.md`、`authoring/README.md`、`docs/SESSION_HANDOFF_20260729.md` を読んでください。
>
...
- 過去問: 569問
  ...
  - 多肢選択式: 30問
  - 記述式: 30問
- ○×学習カード: 187件（行政法65・基礎知識32・民法30・憲法24・商法・会社法24・基礎法学12）
  - ○×の内訳: ○82件・×105件（民法47%・憲法50%・基礎法学50%・基礎知識44%・商法42%・行政法40%）
- ⑤に使う関連過去問肢: 重複を除いて702件、各カードへの表示は延べ782件
- ⑥「似た制度・他分野との違い」: 75カード（関連付け76件）
...
- 法令基準日: 2026-04-01
- bundle revision:
  `7421faf7ba6c520936f45793f08198435f9e2f3bfd738dbe05f26ff9a5c200cb`
