...
> 直近10年の全6科目569問は「過去問原文」と「記述式」へ掲載済みです。○×学習カードは100件（行政法55・民法25・基礎知識20）です。まず `AGENTS.md`、`HANDOFF.md`、`ARCHITECTURE.md`、`authoring/README.md`、`docs/SESSION_HANDOFF_20260728.md` を読んでください。
>
...
- 過去問: 569問
  ...
  - 多肢選択式: 30問
  - 記述式: 30問
- ○×学習カード: 100件（行政法55・民法25・基礎知識20）
- ⑤に使う関連過去問肢: 重複を除いて344件、各カードへの表示は延べ401件
- ⑥「似た制度・他分野との違い」: 44カード
- ⑦「法律ごとの結論くらべ」: 2カード
- Claude監査候補: 20件
- 類似候補: 588組
