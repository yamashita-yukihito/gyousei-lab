...
> 直近10年の全6科目569問は「過去問原文」と「記述式」へ掲載済みです。○×学習カードは115件（行政法55・民法25・基礎知識20・商法・会社法15）です。まず `AGENTS.md`、`HANDOFF.md`、`ARCHITECTURE.md`、`authoring/README.md`、`docs/SESSION_HANDOFF_20260728.md` を読んでください。
>
> 自信度の記録と卒業（習得済み・絶対覚えた・全リセット・卒業済みだけ）と、商法・会社法の厳選15枚は2026年7月29日に実装済みです。次は憲法・基礎法学のカード新設を先に行い、⑦「法律ごとの結論くらべ」の横断整備と基礎知識の残りは、全科目がそろってからにしてください（利用者の指示）。優先順位の根拠は `ARCHITECTURE.md` の「1.5 得点計画」と「12. 次に行う作業」です。
>
...
- 過去問: 569問
  ...
  - 多肢選択式: 30問
  - 記述式: 30問
- ○×学習カード: 115件（行政法55・民法25・基礎知識20・商法・会社法15）
- ⑤に使う関連過去問肢: 重複を除いて401件、各カードへの表示は延べ460件
- ⑥「似た制度・他分野との違い」: 44カード
- ⑦「法律ごとの結論くらべ」: 2カード
- Claude監査候補: 20件
- 類似候補: 588組
- 過去問の収録科目: 基礎法学、憲法、行政法、民法、商法・会社法、基礎知識
- ○×学習カードの収録科目: 行政法、民法、基礎知識、商法・会社法
- 法令基準日: 2026-04-01
- bundle revision:
