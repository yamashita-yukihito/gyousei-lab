...
**ただし⑤との衝突が残っている。** ⑤へ出せるのは平成28年度以降の肢だけなので、
旧10年（平成18〜27年度）にしか出ていない論点は、2回以上出ていてもカードにできない。
該当するのは法定相続分900条、代襲相続887条2項・891条、相続放棄939条、遺留分1042条・1046条、
借地借家法である。**この扱いをどうするかは未決**（`docs/FP2_OVERLAP_CARDS.md` の末尾）。
